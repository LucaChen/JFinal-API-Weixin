            ...
            <div class="navbar-default sidebar" role="navigation"style="width:234px">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu" >
                        ...
                        <li>
                            <a href="forms.html"><i class="fa fa-book fa-fw"></i> 出库管理</a>
                        </li>
                        <li>
                            <a href="forms.html"><i class="fa fa-coffee fa-fw"></i> 入库管理</a>
                        </li>
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal" name="from1" id="from1" action="/addequipment" method="get" >
                            <div class="form-group">
                                <label class="col-sm-2 control-label"  style="margin-left: 12% "for="equipmentname" v>器材名称</label>
                                <div class="col-sm-4">
                                    <input class="form-control" name="equipment.equipmentname" id="equipmentname"  style="margin-left: 7%"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="equipmenttypeid" style="margin-left: 12% ">类别代码</label>
                                <div class="col-sm-4">
                                    <input class="form-control" name="equipment.equipmenttypeid" id="equipmenttypeid" style="margin-left: 7%"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="property" style="margin-left: 12% ">属性</label>
                                <div class="col-sm-4">
                                    <input class="form-control" name="equipment.property" id="property" style="margin-left: 7%"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="describe" style="margin-left: 12% ">器材描述</label>
                                <div class="col-sm-4">
                                    <input class="form-control" name="equipment.describe" id="describe" style="margin-left: 7%"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="unit" style="margin-left: 12% " >单位</label>
                                <div class="col-sm-4">
                                    <input class="form-control" name="equipment.unit" id="unit" style="margin-left: 7%"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="flag" style="margin-left: 12% " > 条码前缀</label>
                                <div class="col-sm-4">
                                    <input class="form-control" name="equipment.flag" id="flag"style="margin-left: 7%"/>
                                </div>
                            </div>
